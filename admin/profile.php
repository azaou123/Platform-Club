            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="profile">
                    ...
                    <div class="profile-info">
                        <h2><?php echo $user['NomComplet']; ?></h2>
                        <p><?php echo $dod->getRole($user['RoleID'], $dbConnection); ?></p>
                    </div>
                        ...
                        <div class="tab-pane fade show active" id="posts">
                            <div class="user-info-container mt-3">
                                <div class="user-details  mt-3">
                                    <h4><?php echo $user['NomComplet']; ?></h4>
                                    <ul class="user-info-list">
                                        <li><strong>User ID:</strong> <?php echo $user['UserID']; ?></li>
                                        <li><strong>Motif:</strong> <?php echo $user['Motif']; ?></li>
                                        <li><strong>Telephone:</strong> <?php echo $user['Telephone']; ?></li>
                                        <li><strong>Email:</strong> <?php echo $user['Email']; ?></li>
                                        <li><strong>Account State:</strong> <?php echo $user['AccountState']; ?></li>
                                        <li><strong>Facebook:</strong> <?php echo $user['Facebook']; ?></li>
                                        <li><strong>Instagram:</strong> <?php echo $user['Insta']; ?></li>
                                        <li><strong>LinkedIn:</strong> <?php echo $user['Linkedin']; ?></li>
                                        <li><strong>Cellule ID:</strong> <?php echo $user['CelluleID']; ?></li>
                                        <li><strong>Role:</strong> <?php echo $dod->getRole($user['RoleID'], $dbConnection); ?></li>
                                        <li><strong>Project ID:</strong> <?php echo $user['ProjetID']; ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="about">
                            ...
                            <form method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="edit_nomcomplet" name="edit_nomcomplet" value="<?php echo htmlspecialchars($user['NomComplet']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="edit_motif">Motif:</label>
                                    <input type="text" class="form-control" id="edit_motif" name="edit_motif" value="<?php echo htmlspecialchars($user['Motif']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="edit_telephone">Telephone:</label>
                                    <input type="text" class="form-control" id="edit_telephone" name="edit_telephone" value="<?php echo htmlspecialchars($user['Telephone']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="edit_email">Email:</label>
                                    <input type="email" class="form-control" id="edit_email" name="edit_email" value="<?php echo htmlspecialchars($user['Email']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="edit_facebook">Facebook:</label>
                                    <input type="text" class="form-control" id="edit_facebook" name="edit_facebook" value="<?php echo htmlspecialchars($user['Facebook']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="edit_insta">Instagram:</label>
                                    <input type="text" class="form-control" id="edit_insta" name="edit_insta" value="<?php echo htmlspecialchars($user['Insta']); ?>">
                                </div>

                                <div class="form-group">
                                    <label for="edit_linkedin">LinkedIn:</label>
                                    <input type="text" class="form-control" id="edit_linkedin" name="edit_linkedin" value="<?php echo htmlspecialchars($user['Linkedin']); ?>">
                                </div>
